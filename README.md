...
Pause/Play Control: Easily pause the timer at any time and resume when you're ready.
...
CSS: All the simple styling and layout.
...
Allowing users to set their own custom focus and break lengths.

Adding a simple task list.
